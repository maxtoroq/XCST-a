...
namespace System.Web.Mvc {
   ...
   class ClientDataTypeModelValidatorProvider : ModelValidatorProvider {
      ...
      static readonly HashSet<Type> _numericTypes = new HashSet<Type>(new Type[] {
      ...
      static IEnumerable<ModelValidator> GetValidatorsImpl(ModelMetadata metadata, ControllerContext context) {
