...
namespace System.Web.Mvc.ExpressionUtil {
   ...
   sealed class FingerprintingExpressionVisitor : ExpressionVisitor {
      ...
      readonly List<object> _seenConstants = new List<object>();
      readonly List<ParameterExpression> _seenParameters = new List<ParameterExpression>();
      readonly ExpressionFingerprintChain _currentChain = new ExpressionFingerprintChain();
      bool _gaveUp;
