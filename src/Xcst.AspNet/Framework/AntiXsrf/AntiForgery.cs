...
namespace System.Web.Helpers {
   ...
   public static class AntiForgery {
      ...
      public static HtmlString GetHtml() {
         ...
         string retVal = _worker.GetFormInputElement(new HttpContextWrapper(context));
      ...
      public static void Validate(HttpContextBase httpContext, string salt) {
         ...
         if (httpContext == null) throw new ArgumentNullException(nameof(httpContext));
         if (!String.IsNullOrEmpty(salt)) throw new NotSupportedException("This method is deprecated. Use the Validate() method instead.");
