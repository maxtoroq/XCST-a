...
namespace System.Web.Mvc {
   ...
   class DataAnnotationsModelValidator : ModelValidator {
      ...
      IsRequired => Attribute is RequiredAttribute;

      public
      DataAnnotationsModelValidator(ModelMetadata metadata, ControllerContext context, ValidationAttribute attribute)
      ...
      Create(ModelMetadata metadata, ControllerContext context, ValidationAttribute attribute) =>
   ...
   class DataAnnotationsModelValidator<TAttribute> : DataAnnotationsModelValidator
      ...
      protected new TAttribute
      Attribute => (TAttribute)base.Attribute;

      public
      DataAnnotationsModelValidator(ModelMetadata metadata, ControllerContext context, TAttribute attribute)
   ...
   class CompareAttributeAdapter : DataAnnotationsModelValidator<DataAnnotationsCompareAttribute> {
      ...
      static string
      FormatPropertyForClientValidation(string property) {
   ...
   class DataTypeAttributeAdapter : DataAnnotationsModelValidator {
      ...
      public
      DataTypeAttributeAdapter(ModelMetadata metadata, ControllerContext context, DataTypeAttribute attribute, string ruleName)
         : base(metadata, context, attribute) {
   ...
   class FileExtensionsAttributeAdapter : DataAnnotationsModelValidator<FileExtensionsAttribute> {
      ...
      public
      FileExtensionsAttributeAdapter(ModelMetadata metadata, ControllerContext context, FileExtensionsAttribute attribute)
         : base(metadata, context, attribute) { }
   ...
   class MaxLengthAttributeAdapter : DataAnnotationsModelValidator<MaxLengthAttribute> {
      ...
      public
      MaxLengthAttributeAdapter(ModelMetadata metadata, ControllerContext context, MaxLengthAttribute attribute)
         : base(metadata, context, attribute) { }
   ...
   class MinLengthAttributeAdapter : DataAnnotationsModelValidator<MinLengthAttribute> {
      ...
      public
      MinLengthAttributeAdapter(ModelMetadata metadata, ControllerContext context, MinLengthAttribute attribute)
         : base(metadata, context, attribute) { }
   ...
   class RangeAttributeAdapter : DataAnnotationsModelValidator<RangeAttribute> {
      ...
      public
      RangeAttributeAdapter(ModelMetadata metadata, ControllerContext context, RangeAttribute attribute)
         : base(metadata, context, attribute) { }
   ...
   class RegularExpressionAttributeAdapter : DataAnnotationsModelValidator<RegularExpressionAttribute> {
      ...
      public
      RegularExpressionAttributeAdapter(ModelMetadata metadata, ControllerContext context, RegularExpressionAttribute attribute)
         : base(metadata, context, attribute) { }
   ...
   class RequiredAttributeAdapter : DataAnnotationsModelValidator<RequiredAttribute> {
      ...
      public
      RequiredAttributeAdapter(ModelMetadata metadata, ControllerContext context, RequiredAttribute attribute)
         : base(metadata, context, attribute) { }
   ...
   class StringLengthAttributeAdapter : DataAnnotationsModelValidator<StringLengthAttribute> {
      ...
      public
      StringLengthAttributeAdapter(ModelMetadata metadata, ControllerContext context, StringLengthAttribute attribute)
         : base(metadata, context, attribute) { }
