...
delegate ModelValidator
DataAnnotationsModelValidationFactory(ModelMetadata metadata, ControllerContext context, ValidationAttribute attribute);

// A factory for validators based on IValidatableObject

delegate ModelValidator
DataAnnotationsValidatableObjectAdapterFactory(ModelMetadata metadata, ControllerContext context);
...
class DataAnnotationsModelValidatorProvider : AssociatedValidatorProvider {
   ...
   internal static Dictionary<Type, DataAnnotationsValidatableObjectAdapterFactory>
   ValidatableFactories = new();

   public static bool
   AddImplicitRequiredAttributeForValueTypes { get; set; }
   ...
   public static void
   RegisterAdapter(Type attributeType, Type adapterType) {
   ...
   public static void
   RegisterAdapterFactory(Type attributeType, DataAnnotationsModelValidationFactory factory) {
   ...
   public static void
   RegisterDefaultAdapter(Type adapterType) {
   ...
   public static void
   RegisterDefaultAdapterFactory(DataAnnotationsModelValidationFactory factory) {
   ...
   GetAttributeAdapterConstructor(Type attributeType, Type adapterType) {
      ...
      var constructor = adapterType.GetConstructor(new[] { typeof(ModelMetadata), typeof(ControllerContext), attributeType })
   ...
   static void
   ValidateAttributeAdapterType(Type adapterType) {
   ...
   static void
   ValidateAttributeFactory(DataAnnotationsModelValidationFactory factory) {
   ...
   /// </summary>
   public static void
   RegisterValidatableObjectAdapter(Type modelType, Type adapterType) {

      ValidateValidatableModelType(modelType);
      ValidateValidatableAdapterType(adapterType);

      var constructor = GetValidatableAdapterConstructor(adapterType);
   ...
   /// </summary>
   public static void
   RegisterValidatableObjectAdapterFactory(Type modelType, DataAnnotationsValidatableObjectAdapterFactory factory) {
   ...
   /// </summary>
   public static void
   RegisterDefaultValidatableObjectAdapter(Type adapterType) {
   ...
   /// </summary>
   public static void
   RegisterDefaultValidatableObjectAdapterFactory(DataAnnotationsValidatableObjectAdapterFactory factory) {
   ...
   GetValidatableAdapterConstructor(Type adapterType) {
      ...
      var constructor = adapterType.GetConstructor(new[] { typeof(ModelMetadata), typeof(ControllerContext) })
   ...
   static void
   ValidateValidatableAdapterType(Type adapterType) {
   ...
   static void
   ValidateValidatableModelType(Type modelType) {
   ...
   static void
   ValidateValidatableFactory(DataAnnotationsValidatableObjectAdapterFactory factory) {
   ...
   static Dictionary<Type, DataAnnotationsModelValidationFactory>
   ...
   static void
   AddValidationAttributeAdapter(Dictionary<Type, DataAnnotationsModelValidationFactory> dictionary, Type validataionAttributeType, DataAnnotationsModelValidationFactory factory) {
   ...
   static void
   AddDataTypeAttributeAdapter(Dictionary<Type, DataAnnotationsModelValidationFactory> dictionary, Type attributeType, string ruleName) {
