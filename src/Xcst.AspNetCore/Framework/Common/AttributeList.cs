...
namespace System.Web.Mvc {
   ...
   sealed class AttributeList : IList<Attribute> {
      ...
      public
      AttributeList(AttributeCollection attributes) {
      ...
      public void
      CopyTo(Attribute[] target, int startIndex) =>
         _attributes.CopyTo(target, startIndex);

      public IEnumerator<Attribute>
      GetEnumerator() {
      ...
      public void
      Insert(int index, Attribute attribute) =>
         throw new NotSupportedException();

      bool
      ICollection<Attribute>.Remove(Attribute attribute) =>
         throw new NotSupportedException();
