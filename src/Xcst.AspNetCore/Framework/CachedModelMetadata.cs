...
namespace System.Web.Mvc {
   ...
   abstract class CachedModelMetadata<TPrototypeCache> : ModelMetadata {
      ...
      bool
      _convertEmptyStringToNullComputed;

      bool
      _dataTypeNameComputed;

      bool
      _descriptionComputed;

      bool
      _displayFormatStringComputed;

      bool
      _displayNameComputed;

      bool
      _editFormatStringComputed;

      bool
      _hasNonDefaultEditFormatComputed;

      bool
      _hideSurroundingHtmlComputed;
      ...
      bool
      _nullDisplayTextComputed;

      bool
      _orderComputed;

      bool
      _shortDisplayNameComputed;

      bool
      _showForDisplayComputed;

      bool
      _showForEditComputed;

      bool
      _templateHintComputed;
      ...
      protected TPrototypeCache
      PrototypeCache { get; set; }
      ...
      protected
      CachedModelMetadata(CachedModelMetadata<TPrototypeCache> prototype, Func<object?>? modelAccessor)
      ...
      protected
      CachedModelMetadata(/*CachedDataAnnotations*/ModelMetadataProvider provider, Type? containerType, Type modelType, string? propertyName, TPrototypeCache prototypeCache)
      ...
      ComputeDataTypeName() => base.DataTypeName;

      protected virtual string?
      ComputeDescription() => base.Description;

      protected virtual string?
      ComputeDisplayFormatString() => base.DisplayFormatString;

      protected virtual string?
      ComputeDisplayName() => base.DisplayName;

      protected virtual string?
      ComputeEditFormatString() => base.EditFormatString;
      ...
      protected virtual bool
      ComputeHideSurroundingHtml() => base.HideSurroundingHtml;

      protected virtual bool
      ComputeHtmlEncode() => base.HtmlEncode;

      protected virtual bool
      ComputeIsReadOnly() => base.IsReadOnly;

      protected virtual bool
      ComputeIsRequired() => base.IsRequired;

      protected virtual string?
      ComputeNullDisplayText() => base.NullDisplayText;

      protected virtual int
      ComputeOrder() => base.Order;

      protected virtual string?
      ComputeShortDisplayName() => base.ShortDisplayName;

      protected virtual bool
      ComputeShowForDisplay() => base.ShowForDisplay;

      protected virtual bool
      ComputeShowForEdit() => base.ShowForEdit;

      protected virtual string
      ComputeSimpleDisplayText() => base.GetSimpleDisplayText();

      protected virtual string?
      ComputeTemplateHint() => base.TemplateHint;

      protected virtual string?
      ComputeWatermark() => base.Watermark;

      protected virtual string?
      ComputeGroupName() => base.GroupName;
   ...
   abstract class CachedAssociatedMetadataProvider<TModelMetadata> : AssociatedMetadataProvider where TModelMetadata : ModelMetadata {
      ...
      protected internal CacheItemPolicy
      CacheItemPolicy { get; set; } = new() {
      ...
      protected internal ObjectCache
      PrototypeCache {
         get => _prototypeCache ?? MemoryCache.Default;
         set => _prototypeCache = value;
      }

      protected sealed override ModelMetadata
      CreateMetadata(IEnumerable<Attribute> attributes, Type? containerType, Func<object?>? modelAccessor, Type modelType, string? propertyName) {
         ...
         var typeForCache = containerType ?? modelType;
         var cacheKey = GetCacheKey(typeForCache, propertyName);
      ...
      protected abstract TModelMetadata
      ...
      protected abstract TModelMetadata
      CreateMetadataFromPrototype(TModelMetadata prototype, Func<object?>? modelAccessor);

      internal string
      GetCacheKey(Type type, string? propertyName = null) {
      ...
      public sealed override ModelMetadata
      ...
      public sealed override IEnumerable<ModelMetadata>
