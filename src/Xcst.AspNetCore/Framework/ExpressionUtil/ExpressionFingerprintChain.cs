...
namespace System.Web.Mvc.ExpressionUtil {
   ...
   sealed class ExpressionFingerprintChain : IEquatable<ExpressionFingerprintChain> {

      public readonly List<ExpressionFingerprint?>
      Elements = new();

      public bool
      Equals(ExpressionFingerprintChain? other) {
