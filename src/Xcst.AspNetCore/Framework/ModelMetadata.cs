...
namespace System.Web.Mvc {
   ...
   public class ModelMetadata {
      ...
      _additionalValues = new(StringComparer.OrdinalIgnoreCase);
      ...
      public virtual Dictionary<string, object?>
      ...
      DataTypeName { get; set; }

      public virtual string?
      Description { get; set; }

      public virtual string?
      DisplayFormatString { get; set; }
      ...
      public virtual string?
      EditFormatString { get; set; }

      internal virtual bool
      HasNonDefaultEditFormat { get; set; }

      public virtual bool
      HideSurroundingHtml { get; set; }
      ...
      public bool
      IsNullableValueType => TypeHelpers.IsNullableValueType(ModelType);
      ...
      public virtual IEnumerable<ModelMetadata>
      Properties {
         get {
            if (_properties is null) {

               var originalProperties = Provider.GetMetadataForProperties(Model, RealModelType);
      ...
      PropertiesAsArray {
         get {
            ...
            var virtualProperties = Properties;

            if (Object.ReferenceEquals(virtualProperties, _properties)) {
               Debug.Assert(_propertiesInternal != null);
...
#pragma warning restore CS8603
      ...
      internal ModelMetadataProvider
      Provider { get; set; }
      ...
      internal static ModelMetadata
      FromLambdaExpression<TParameter, TValue>(Expression<Func<TParameter, TValue>> expression, ViewDataDictionary<TParameter> viewData, ModelMetadataProvider? metadataProvider) {
      ...
      FromModel(ViewDataDictionary viewData, ModelMetadataProvider? metadataProvider) =>
      ...
      internal static ModelMetadata
      FromStringExpression(string expression, ViewDataDictionary viewData, ModelMetadataProvider? metadataProvider) {
         ...
         if (vdi != null) {
            ...
            var propertyMetadata = viewData.ModelMetadata.Properties
      ...
      GetMetadataFromProvider(Func<object?>? modelAccessor, Type modelType, string? propertyName, object? container, Type? containerType, ModelMetadataProvider? metadataProvider) {
      ...
      GetSimpleDisplayText() {
         ...
         var toStringResult = Convert.ToString(this.Model, CultureInfo.CurrentCulture);
         ...
         var firstProperty = this.Properties.FirstOrDefault();
   ...
   public class ModelMetadataProviders {
      ...
      IResolver<ModelMetadataProvider>
      _resolver;

      internal
      ModelMetadataProviders(IResolver<ModelMetadataProvider>? resolver = null) {
         _resolver = resolver
      ...
      public static ModelMetadataProvider
      Current {
